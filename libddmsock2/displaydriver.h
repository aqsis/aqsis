...
/** \enum EqDDRequestIDs
 *  IDs of the requests made from the client to the server for information. 
 */
enum EqDDRequestIDs
{
    RequestID_Format = 0,
...
struct SqDDMessageOpen : public SqDDMessageBase
{
    SqDDMessageOpen()
    {}
    SqDDMessageOpen( TqInt xres, TqInt yres, TqInt channels, TqInt cwxmin, TqInt cwxmax, TqInt cwymin, TqInt cwymax, TqInt buckets ) :
