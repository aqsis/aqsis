...
# ADD CPP /nologo /MD /W3 /GR /GX /O2 /I "..\render" /I "..\libaqsistypes" /I "..\libaqsistypes\win32\intel" /I "..\libshaderexecenv" /I "..\libshadervm" /I "..\..\win32libs\include" /I "..\boost" /I "..\thirdparty\tinyxml" /I "..\libdd2" /D "NDEBUG" /D "PLUGINS" /D "AQSIS_DYNAMIC_LINK" /D _qBUILDING=BUILD_LIBDDMSOCK /D BUILD_LIBDDMSOCK=1 /D "_MBCS" /D "_LIB" /D _qBUILDING=CORE /D CORE=1 /D "WIN32" /D "NO_SYSLOG" /D "TIXML_USE_STL" /YX /FD /c
...
# ADD LIB32 /nologo /out:"..\lib\ddmsock2.lib"
...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /I "..\render" /I "..\libaqsistypes" /I "..\libaqsistypes\win32\intel" /I "..\libshaderexecenv" /I "..\libshadervm" /I "..\..\win32libs\include" /I "..\boost" /I "..\thirdparty\tinyxml" /I "..\libdd2" /D "_DEBUG" /D "AQSIS_DYNAMIC_LINK" /D _qBUILDING=BUILD_LIBDDMSOCK /D BUILD_LIBDDMSOCK=1 /D "_MBCS" /D "_LIB" /D _qBUILDING=CORE /D CORE=1 /D "WIN32" /D "NO_SYSLOG" /D "TIXML_USE_STL" /YX /FD /GZ /c
...
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo
# ADD LIB32 /nologo /out:"..\lib\ddmsock2_d.lib"
