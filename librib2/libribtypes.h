...
public:
	...
	RendermanInterface::RtInt Count() { return m_Array->Count(); }
	RendermanInterface::RtToken Token() { return m_Token; }
	RendermanInterface::RtPointer Values() { return m_Array->Values(); }
...
public:
	...
	RendermanInterface::RtInt Count() { return m_Tokens.size(); }
	RendermanInterface::RtInt* Counts() { return m_Counts.size() ? & m_Counts[0] : 0; }
	RendermanInterface::RtToken* Tokens() { return m_Tokens.size() ? &m_Tokens[0] : 0; }
	RendermanInterface::RtPointer* Values() { return m_Values.size() ? &m_Values[0] : 0; }
