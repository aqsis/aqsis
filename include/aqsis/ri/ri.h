...
def printDecl(returnType, procName, args):
    cog.outl(declTemplate % (returnType, procName, ', '.join(args)))
...
AQSIS_RI_SHARE RtVoid RiBlobby(RtInt nleaf, RtInt ncode, RtInt code[], RtInt nfloats, RtFloat floats[], RtInt nstrings, RtToken strings[], ...);
