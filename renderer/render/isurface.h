...
struct IqSurface
{
	 ...
	 */
	virtual TqInt	PreSubdivide( std::vector<boost::shared_ptr<CqBasicSurface> >& aSplits, TqBool u ) = 0;
	/** Interpolate the specified value using the natural interpolation method for the surface.
	...
	/** Perform any post cleanup after dicing.
	 */
	virtual void	PostSubdivide( std::vector<boost::shared_ptr<CqBasicSurface> >& aSplits ) = 0;
