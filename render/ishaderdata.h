...
struct IqShaderData
{
		...
		void GetValue( TqFloat& f, TqInt index = 0 ) const		{ GetFloat( f, index ); }
		void GetValue( TqBool& b, TqInt index = 0 ) const		{ GetBool( b, index ); }
		void GetValue( CqString& s, TqInt index = 0 ) const		{ GetString( s, index ); }
		...
		void SetValue( const TqBool& b )		{ SetBool( b ); }
		void SetValue( const CqString& s )		{ SetString( s ); }
		void SetValue( const CqVector3D& p )	{ SetPoint( p ); }
		void SetValue( const CqColor& c )		{ SetColor( c ); }
		void SetValue( const CqMatrix& m )		{ SetMatrix( m ); }

		void SetValue( const TqFloat& f, TqInt index )		{ SetFloat( f, index ); }
		void SetValue( const TqInt& i , TqInt index)		{ SetFloat( static_cast<TqFloat>( i ), index ); }
		void SetValue( const TqBool& b, TqInt index )		{ SetBool( b, index ); }
		void SetValue( const CqString& s, TqInt index )		{ SetString( s, index ); }
		void SetValue( const CqVector3D& p, TqInt index )	{ SetPoint( p, index ); }
		void SetValue( const CqColor& c, TqInt index )		{ SetColor( c, index ); }
		void SetValue( const CqMatrix& m, TqInt index )		{ SetMatrix( m, index ); }
