...
struct IqShaderExecEnv
{
		...
		virtual	void	Initialise( const TqInt uGridRes, const TqInt vGridRes, CqSurface* pSurface, TqInt Uses ) = 0;
		/** Get grid size in u
		 */
		...
		virtual STD_SO	SO_clamp( FLOATVAL a, FLOATVAL min, FLOATVAL max, DEFPARAM ) = 0;
		virtual STD_SO	SO_pclamp( POINTVAL a, POINTVAL min, POINTVAL max, DEFPARAM ) = 0;
		virtual STD_SO	SO_cclamp( COLORVAL a, COLORVAL min, COLORVAL max, DEFPARAM ) = 0;
		...
		virtual STD_SO	SO_step( FLOATVAL min, FLOATVAL value, DEFPARAM ) = 0;
		virtual STD_SO	SO_smoothstep( FLOATVAL min, FLOATVAL max, FLOATVAL value, DEFPARAM ) = 0;
