...
class CqShaderVariableArray: public CqShaderVariable
{
	...
	{}
		...
		{
			return ( static_cast<EqVariableType>( m_aVariables[ 0 ] ->Type() | Type_Array ) );
		}
		 ...
		 */
		std::vector<CqShaderVariable*>& aVariables()
		{
			return ( m_aVariables );
		}
		 ...
		 */
		CqShaderVariable* operator[] ( TqUint index )
		{
...
class CqShaderVariableUniform : public CqShaderVariableTyped<R>
{
	public:
		...
		virtual	EqVariableType	Type() const
		{
			return ( static_cast<EqVariableType>( T | Type_Uniform | Type_Variable ) );
		}
		virtual	CqShaderVariable* Clone() const
		{
...
class CqShaderVariableVarying : public CqShaderVariableTyped<R>
{
	public:
		...
		virtual	EqVariableType	Type() const
		{
			return ( static_cast<EqVariableType>( T | Type_Varying | Type_Variable ) );
		}
		virtual	CqShaderVariable* Clone() const
		{
