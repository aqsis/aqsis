...
class _qShareC YY_@_CLASS YY_@_INHERIT
{
public: 
#if YY_@_USE_CONST_TOKEN != 0
...
#endif
public:
 _qShareM int YY_@_PARSE (YY_@_PARSE_PARAM);
 _qShareM virtual void YY_@_ERROR(const char *msg) YY_@_ERROR_BODY;
#ifdef YY_@_PURE
#ifdef YY_@_LSP_NEEDED
 _qShareM virtual int  YY_@_LEX (YY_@_STYPE *YY_@_LVAL,YY_@_LTYPE *YY_@_LLOC) YY_@_LEX_BODY;
#else
 _qShareM virtual int  YY_@_LEX (YY_@_STYPE *YY_@_LVAL) YY_@_LEX_BODY;
#endif
#else
 _qShareM virtual int YY_@_LEX() YY_@_LEX_BODY;
...
#endif
public:
 _qShareM YY_@_CLASS(YY_@_CONSTRUCTOR_PARAM);
public:
 YY_@_MEMBERS 
};
/* other declare folow */
