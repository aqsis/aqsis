...
class _qShareC	CqColor
{
	...
	_qShareM					~CqColor()	{}
								 ...
								 */
	_qShareM	TqFloat			fRed() const	{return(m_fRed);}
	...
	_qShareM	void			SetfRed(const TqFloat fValue)
								 ...
								 */
	_qShareM	TqFloat			fGreen() const	{return(m_fGreen);}
	...
	_qShareM	void			SetfGreen(const TqFloat fValue)
								 ...
								 */
	_qShareM	TqFloat			fBlue() const	{return(m_fBlue);}
	...
	_qShareM	TqBool		operator<(const CqColor &colCmp) const
								 ...
								 */
	_qShareM	friend CqColor	operator+(const TqFloat f, const CqColor& c)	{CqColor r(c); return(r+=f);}
								/** Component wise friend addition operator.
								 * \param c color to add to.
								 * \param f float to add to each component.
								 * \return new color representing addition. 
								 */
	_qShareM	friend CqColor	operator+(const CqColor& c, const TqFloat f)	{CqColor r(c); return(r+=f);}
								 ...
								 */
	_qShareM	friend CqColor	operator-(const TqFloat f, const CqColor& c)	{CqColor r(f,f,f); return(r-=c);}
								/** Component wise friend subtraction operator.
								 * \param c color to subtract from.
								 * \param f float to subtract from each component.
								 * \return new color representing subtraction. 
	...
	_qShareM	friend CqColor	operator/(const CqColor& c, const TqFloat f)	{CqColor r(c); return(r/=f);}
								 ...
								 * \return new color representing addition. 
								 */
	_qShareM	friend CqColor	operator+(const CqColor& a, const CqColor& b)	{CqColor r(a); return(r+=b);}
								/** Component wise friend subtraction operator.
