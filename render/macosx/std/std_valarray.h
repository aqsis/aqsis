...
//#include <std/valarray_array.h>	// macaqsis
#include "valarray_array.h"	// macaqsis 
//#include <std/valarray_meta.h>	// macaqsis
#include "valarray_meta.h"	// macaqsis
...
extern "C++"
{
	...
	{
		_Tp operator() ( _Tp __x, _Tp __y ) const
		{
			return __x & __y;
		}
	};
...
// macaqsis - disable includes until Apple adds libstdc++ headers in distribution
//#include <std/slice.h>		// macaqsis
//#include <std/slice_array.h>		// macaqsis
//#include <std/gslice.h>		// macaqsis
//#include <std/gslice_array.h>		// macaqsis
//#include <std/mask_array.h>		// macaqsis
//#include <std/indirect_array.h>		// macaqsis
