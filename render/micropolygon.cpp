...
TqBool CqMicroPolygon::SampleDof( const CqVector2D& vecSample, TqFloat time, const TqFloat* DofParameters, const CqVector2D& LensPosition, TqFloat& D )
{
	...
	*/
	...
	// Fits better with dct.Magnitude than when scaling LensPosition by 
	// the right x,y values, though I have no idea why...
	return fContains( vecSample + dct.Magnitude() * LensPosition, D );
}
