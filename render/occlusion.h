...
public:
	...
	static void Update() { UpdateLevel(m_HierarchyLevels - 1); }

	static bool CanCull(CqBound* bound) { return m_Hierarchy[0].IsCullable(bound); }
...
protected:
	...
	bool NeedsUpdating(){ return m_NeedsUpdating; }
	void MarkForUpdate(){ m_NeedsUpdating = true; }
