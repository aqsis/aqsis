...
# ADD CPP /nologo /MD /W3 /GR /GX /O2 /I "..\Object\Release\ribber" /I "..\Object\Release\render" /I "..\Render" /I "..\libaqsistypes" /I "..\libaqsistypes\win32\intel" /I "..\libargparse" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /D "PLUGINS" /D "WIN32" /D "AQSIS_DYNAMIC_LINK" /D _qBUILDING=BUILD_TEQSER /D BUILD_TEQSER=1 /FR /YX /FD /c
...
# ADD LINK32 libargparse.lib log4cpp.lib libz.lib librib2.lib librib2ri.lib libshadervm.lib libshaderexecenv.lib libddmsimple.lib libtiff.lib libaqsistypes.lib libaqsis.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /profile /debug /machine:I386 /nodefaultlib:"libc.lib" /libpath:"..\Library\Profile"
