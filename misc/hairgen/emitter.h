...
class EmitterMesh
{
	public:
		 ...
		 */
		EmitterMesh(const Aqsis::TqRiIntArray& nverts, const Aqsis::TqRiIntArray& verts,
	...
	private:
		...
		void createFaceList(const Aqsis::TqRiIntArray& nverts,
				const Aqsis::TqRiIntArray& verts, FaceVec& faces) const;
