...
SET(AQSIS_FLTK_LIBRARIES_SEARCHPATH)
SET(AQSIS_FLTK_FLUID_SEARCHPATH)
SET(AQSIS_FLTK_PLATFORM_DEPENDENT_LIBS)

#  Platform dependent libraries required by FLTK
IF(WIN32)
  SET( AQSIS_FLTK_PLATFORM_DEPENDENT_LIBS ${AQSIS_FLTK_PLATFORM_DEPENDENT_LIBS} wsock32 comctl32 )
ENDIF(WIN32)
...
IF(WIN32)
	IF(AQSIS_WIN32LIBS)
		...
		IF(MSVC AND MSVC80)
			SET(AQSIS_FLTK_LIBRARIES_SEARCHPATH ${AQSIS_FLTK_LIBRARIES_SEARCHPATH} ${AQSIS_WIN32LIBS}/FLTK/lib/vc8_sp1)
...
FIND_LIBRARY(AQSIS_FLTK_LIBRARIES
			fltk
			PATHS ${AQSIS_FLTK_LIBRARIES_SEARCHPATH}
...
STRING(COMPARE EQUAL "${AQSIS_FLTK_LIBRARIES}" "AQSIS_FLTK_LIBRARIES-NOTFOUND" AQSIS_FLTK_LIBRARIES_NOTFOUND)
STRING(COMPARE EQUAL "${FLTK_FLUID_EXECUTABLE}" "FLTK_FLUID_EXECUTABLE-NOTFOUND" AQSIS_FLTK_FLUID_NOTFOUND)

IF(NOT AQSIS_FLTK_LIBRARIES_NOTFOUND AND NOT AQSIS_FLTK_INCLUDE_NOTFOUND AND NOT AQSIS_FLTK_FLUID_NOTFOUND)
	SET(AQSIS_FLTK_FOUND 1)
	SET(AQSIS_FLTK_LIBRARIES ${AQSIS_FLTK_LIBRARIES} ${AQSIS_FLTK_PLATFORM_DEPENDENT_LIBS})
ENDIF(NOT AQSIS_FLTK_LIBRARIES_NOTFOUND AND NOT AQSIS_FLTK_INCLUDE_NOTFOUND AND NOT AQSIS_FLTK_FLUID_NOTFOUND)
