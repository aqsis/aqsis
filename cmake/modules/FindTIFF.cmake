...
IF(WIN32)
	IF(AQSIS_WIN32LIBS)
		...
		IF(MSVC AND MSVC80)
			SET(AQSIS_TIFF_LIBRARIES_DIR ${AQSIS_TIFF_LIBRARIES_DIR} ${AQSIS_WIN32LIBS}/libtiff/lib/vc8)
			SET(AQSIS_TIFF_LIBRARY_NAMES ${AQSIS_TIFF_LIBRARY_NAMES} libtiff)
		ELSE(MSVC AND MSVC80)
			IF(MINGW)
				SET(AQSIS_TIFF_LIBRARIES_DIR ${AQSIS_TIFF_LIBRARIES_DIR} ${AQSIS_WIN32LIBS}/libtiff/lib/mingw)
			ENDIF(MINGW)
