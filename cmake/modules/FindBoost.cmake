...
IF(WIN32)
		...
		SET(AQSIS_BOOST_THREAD_LIBRARY_NAME libboost_thread-vc90-mt CACHE STRING "The name of the boost_thread library (undecorated, i.e. the string passed to the compiler)")
		SET(AQSIS_BOOST_UNIT_TEST_FRAMEWORK_LIBRARY_NAME libboost_unit_test_framework-vc90-mt CACHE STRING "The name of the boost_unit_test_framework library (undecorated, i.e. the string passed to the compiler)")
		SET(AQSIS_BOOST_WAVE_LIBRARY_NAME libboost_wave-vc90-mt CACHE STRING "The name of the boost_wave library (undecorated, i.e. the string passed to the compiler)")
		SET(AQSIS_BOOST_FILESYSTEM_LIBRARY_NAME libboost_filesystem-vc90-mt CACHE STRING "The name of the boost_filesystem library (undecorated, i.e. the string passed to the compiler)")
