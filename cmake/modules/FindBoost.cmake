...
ELSE(WIN32)
	SET(AQSIS_BOOST_THREAD_LIBRARY_NAME boost_thread${AQSIS_BOOST_VERSION_SUFFIX} CACHE STRING "The name of the boost_thread library (undecorated, i.e. the string passed to the compiler)")
	SET(AQSIS_BOOST_UNIT_TEST_FRAMEWORK_LIBRARY_NAME boost_unit_test_framework${AQSIS_BOOST_VERSION_SUFFIX} CACHE STRING "The name of the boost_unit_test_framework library (undecorated, i.e. the string passed to the compiler)")
	SET(AQSIS_BOOST_WAVE_LIBRARY_NAME boost_wave${AQSIS_BOOST_VERSION_SUFFIX} CACHE STRING "The name of the boost_wave library (undecorated, i.e. the string passed to the compiler)")
	SET(AQSIS_BOOST_FILESYSTEM_LIBRARY_NAME boost_filesystem${AQSIS_BOOST_VERSION_SUFFIX} CACHE STRING "The name of the boost_filesystem library (undecorated, i.e. the string passed to the compiler)")
ENDIF(WIN32)
