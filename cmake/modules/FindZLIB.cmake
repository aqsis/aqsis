...
IF(WIN32)
	IF(AQSIS_WIN32LIBS)
		...
		IF(MSVC AND MSVC80)
			SET(AQSIS_ZLIB_LIBRARIES_DIR ${AQSIS_ZLIB_LIBRARIES_DIR} ${AQSIS_WIN32LIBS}/zlib/lib/vc8)
			SET(AQSIS_ZLIB_LIBRARY_NAMES ${AQSIS_ZLIB_LIBRARY_NAMES} zlibstat)
		ELSE(MSVC AND MSVC80)
			IF(MINGW)
				SET(AQSIS_ZLIB_LIBRARIES_DIR ${AQSIS_ZLIB_LIBRARIES_DIR} ${AQSIS_WIN32LIBS}/zlib/lib/mingw)
