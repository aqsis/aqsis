...
BOOST_AUTO_TEST_CASE(GridStorageBuilder_unique_test)
{
    ...
    builder.add(Stdvar::P, true);
    builder.add(Stdvar::Cs, true);
    builder.add(Stdvar::P, true);
    builder.add(Stdvar::Ci, true);
    builder.add(Stdvar::P, true);
...
BOOST_AUTO_TEST_CASE(GridStorage_maxAggregateSize_test)
{
    GridStorageBuilder builder;
    builder.add(Stdvar::P, false);
    builder.add(VarSpec(VarSpec::Float, 42, ustring("f")), false);
    boost::shared_ptr<GridStorage> stor = builder.build(10);
