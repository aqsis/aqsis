...
BuildDir('build/libaqsistypes', 'libaqsistypes')
SConscript('build/libaqsistypes/SConscript')
BuildDir('build/libargparse', 'libargparse')
SConscript('build/libargparse/SConscript')
BuildDir('build/libddmanager', 'libddmanager')
SConscript('build/libddmanager/SConscript')
BuildDir('build/libraytrace', 'libraytrace')
SConscript('build/libraytrace/SConscript')
BuildDir('build/librib2', 'librib2')
SConscript('build/librib2/SConscript')
BuildDir('build/librib2ri', 'librib2ri')
SConscript('build/librib2ri/SConscript')
BuildDir('build/libshaderexecenv', 'libshaderexecenv')
SConscript('build/libshaderexecenv/SConscript')
BuildDir('build/libshadervm', 'libshadervm')
SConscript('build/libshadervm/SConscript')
BuildDir('build/libaqsis', 'render')
SConscript('build/libaqsis/SConscript')
BuildDir('build/aqsis', 'aqsis')
SConscript('build/aqsis/SConscript')
BuildDir('build/libslparse', 'libslparse')
SConscript('build/libslparse/SConscript')
BuildDir('build/libcodegenvm', 'libcodegenvm')
SConscript('build/libcodegenvm/SConscript')
BuildDir('build/slpp', 'slpp')
SConscript('build/slpp/SConscript')
BuildDir('build/aqsl', 'aqsl')
SConscript('build/aqsl/SConscript')
BuildDir('build/libslxargs', 'libslxargs')
SConscript('build/libslxargs/SConscript')
BuildDir('build/aqsltell', 'aqsltell')
SConscript('build/aqsltell/SConscript')
BuildDir('build/display', 'display')
display = SConscript('build/display/SConscript')
BuildDir('build/libri2rib', 'libri2rib')
SConscript('build/libri2rib/SConscript')
BuildDir('build/librib2stream', 'librib2stream')
SConscript('build/librib2stream/SConscript')
