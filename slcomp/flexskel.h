...
#else
#define YY_@_INPUT_CODE if(YY_@_IN->eof())  result=0;else {YY_@_IN->read(buffer,max_size);result=YY_@_IN->gcount();YY_@_IN->clear(YY_@_IN->rdstate()&(~std::ios_base::failbit));if(YY_@_IN->bad()) result= -1;} return result;
#endif
#endif
