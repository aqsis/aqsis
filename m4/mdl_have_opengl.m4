...
dnl URL accordingly.
dnl
dnl @version 0.01 $Id: mdl_have_opengl.m4,v 1.1 2003/02/28 16:51:30 minty Exp $
...
dnl Check for Mesa first, unless we were asked not to.
    AC_ARG_ENABLE(Mesa, [  --enable-Mesa	Prefer the Mesa library over a vendors native OpenGL library (default=yes)], enable_Mesa=yes)
