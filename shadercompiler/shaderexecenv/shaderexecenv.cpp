...
CqShaderExecEnv::CqShaderExecEnv(boost::shared_ptr<IqRenderer> pRenderContext) : m_li( 0 ), m_Illuminate( 0 ), m_pAttributes( 0 ), m_pRenderContext(pRenderContext), m_LocalIndex( 0 )
{
